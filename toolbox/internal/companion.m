function C = companion(poly)
    ...
    %   polynomial in its matrix representation.
    %
    %   C = COMPANION(P) constructs the companion matrix of a univariate
    %   polynomial in its cell representation.
    %
    %   C = COMPANION(system) constructs the companion matrix of a
    %   univariate polynomial in its system representation.
    %
    %   Input arguments:
    %       - poly (matrix | cell | systemstruct): univariate polynomial.
    %
    %   Output arguments:
    %       - C (double): companion matrix.
    %
    %   See also ROOTS.
