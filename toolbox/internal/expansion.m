function q = expansion(p, varargin)
    ...
    %   q = EXPANSION(p) expands a polynomial into the corresponding row 
    %   vector (in the graded reverse lexicographic ordering).
    %
    ...
    %
    %   Input arguments:
    %       - p (double): polynomial in coefficient-exponent matrix 
    %           representation.
    ...
    %
    %   Output arguments:
    %       - q (double): polynomial in row vector representation.
    %
